...
public class IngredientTest {
    ...
    public static class testChangeUnitReturnValidity{
        ...
        public void quantityConverted(){
            ...
            Ingredient theIngredient = new Ingredient(new FoodItem("test item"), initialQuantity, INIT_UNIT);
    ...
    public static class testChangeUnitUnits{
        ...
        public void unitConverted(){
            ...
            Ingredient theIngredient = new Ingredient(new FoodItem("test item"), TEST_QUANTITY, initialUnit);
